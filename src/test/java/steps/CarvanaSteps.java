...
import utilites.DropdownHandler;
...
public class CarvanaSteps {
    ...
    CarvanaSellMyCarPage sellMyCarPage;
    ...
    public void setup() {
        ...
        sellMyCarPage = new CarvanaSellMyCarPage();
    ...
    public void user_clicks_on_menu_item(String clickMenuItem) {
        switch (clickMenuItem) {
            case "CAR FINDER":
                Waiter.waitForVisibilityOfElement(driver, 2, carvanaHomePage.carFinderLink);
            ...
            case "AUTO LOAN CALCULATOR":
                Waiter.waitForVisibilityOfElement(driver, 1, carvanaHomePage.autoLoanCalculatorLink);
    ...
    public void user_should_see_text(String headingText) {
        switch (headingText) {
            ...
            case "https://www.carvana.com/sell-my-car":
                ...
                Waiter.waitUntilTextToBePresentInElement(driver, 2, sellMyCarPage.weFoundYourPinText,headingText);
    ...
    public void userHoversOverOnMenuItem(String buttonText) {
        ...
        Waiter.pause(1);
        ActionHandler.moveToElement(carvanaHomePage.financingMenuButton);
    }
